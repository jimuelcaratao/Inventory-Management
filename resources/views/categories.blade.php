...
<div class="left-navbar" id="left-navbar">
  ...
  <div class="left-navbar-links">
      ...
      <a href="{{ URL::to('categories') }}" class="navbar-link-active"><i class="fas fa-clipboard icons"></i><span class="navbar-span icon_color">Category</span></a>
                              ...
                              <thead>
                                ...
                                <tr class="data-row table-sm table-product">
                                    ...
                                    <td>
                                      ...
                                      data-item-name="{{ $category->category_name }}"
                                      data-item-status="{{ $category->status }}"
                                      id="edit-item"
                                      ><i class="far fa-edit icons"></i></a>
            
                                      {{-- delete icon --}}
                                      <form method="POST" action="/categories/{{$category->category_id}}" class="float-left">
                                        @csrf
                                        @method("DELETE")
 ...
 <div class="modal fade" id="add-modal" tabindex="-1" role="dialog" aria-labelledby="add-modal-label" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-scrollable" role="document">
      <div class="modal-content">
        ...
        <form id="add-form" class="form-horizontal" action="{{ route('categories.store') }}" method="POST">
            @csrf
            <div class="card text-black bg-light mb-0">
              ...
              <div class="card-body">
                ...
                <!-- Category Name --> 
                <div class="form-group input-group-sm">
                  <label class="col-form-label" for="inputCategoryName">Category Name</label>
                <input type="text" name="inputCategoryName" class="form-control " id="inputCategoryName" required >
                </div>
                <!-- /Category Name -->
                <!-- Status --> 
                <div class="form-group input-group-sm">
...
<div class="modal fade" id="edit-modal" tabindex="-1" role="dialog" aria-labelledby="edit-modal-label" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-scrollable" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body" id="attachment-body-content">
          @forelse ($categories as $category)
          <form id="edit-form_{{$category->category_id}}" class="form-horizontal" method="POST" action="/categories/{{$category->category_id}}">
          @empty
          @endforelse
            @csrf
            {{ method_field('PUT') }}
            <div class="card text-dark bg-light mb-0">
              ...
              <div class="card-body">
                ...
                <!-- Category Name --> 
                <div class="form-group input-group-sm">
                    <label class="col-form-label" for="editCategoryName">Category Name</label>
                    <input type="text" name="editCategoryName" class="form-control " id="editCategoryName" required >
                </div>
                <!-- /Category Name -->
                <!-- Status --> 
                <div class="form-group input-group-sm">
